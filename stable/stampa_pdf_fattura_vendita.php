...
$body = "
<p align=\"center\"><b>FATTURA DI VENDITA</b></p>
<table align=\"center\" border=\"1\" style=\"height: 100%;\">
	<tr><td align=\"center\" valign=\"top\">FATTURA N. <br />
		<b>$num_doc</b>
	</td><td align=\"center\" valign=\"top\">DEL <br />
		<b>$data_doc</b>
	</td>
";
if ($campi_ricevuta['id_cliente'] != 0){
	...
	$cod_fiscale = $campi_cliente['cod_fiscale'];
	if ($cod_fiscale=="") { $cod_fiscale = $p_iva_cliente; }
	
	$body .= "
	<td colspan=\"4\" align=\"right\">Spett.le<br />
		<b>$nome_cliente $cognome_cliente</b> <br />
		$indirizzo_cliente <br />
		$citta_cliente - $cap_cliente <br />
		P.I. $p_iva_cliente C.F. <b>$cod_fiscale</b>
	</td></tr>
	";
} else {
	$body .= "
...
$imponibile_fat = $totale/1.22;
$imponibile_fat = money_format('%.2n',$imponibile_fat);
$iva_fat = $totale-$imponibile_fat;
$iva_fat = money_format('%.2n',$iva_fat);
$body .= "
	...
	$riga_lista
	<tr><td height=\"200\" colspan=\"3\" valign=\"bottom\" align=\"right\">
	IMPONIBILE:<br />
	IVA:<br /><br />
	TOTALE FATTURA: 
	</td> <td></td><td> </td>
	...
	$imponibile_fat<br />
	$iva_fat<br /><br />
	<b>&euro; $totale</b></td></tr>
</table>
";

ob_end_clean ();

$content = "<page>".$header.$body."<br /><br /><br />".
"<table width=\"100%\" style=\"font-size: 0.9em;\">
	<tr><td align=\"center\">Per quietanza</td></tr><tr><td><br /><br />______________________</td></tr></table></page>";
    // convert in PDF
