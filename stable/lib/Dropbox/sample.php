...
$dropbox = new DropboxClient(array(
	'app_key' => "71k5v29qryaeyyn", 
	'app_secret' => "3pt9h6t1aexdi5j",
...
//	echo "Accesso Dropbox eseguito con l'account: ";
...
if(!$dropbox->IsAuthorized())
{
	...
	$return_url = "http://".$_SERVER['HTTP_HOST']."/mercusa/servers/ilripostiglio/index.php?loc=05&sez=Mailmessage&auth_callback=1";
	$auth_url = $dropbox->BuildAuthorizeUrl($return_url);
	$request_token = $dropbox->GetRequestToken();
	store_token($request_token, $request_token['t']);
	die("Devi collegare il tuo DropBox. <a href='$auth_url'>Clicca qui.</a>");
}

//echo "<b>Account:</b>\r\n";
//print_r($dropbox->GetAccountInfo());

$accountArr = $dropbox->GetAccountInfo();
//foreach ($accountArr as $a) {
