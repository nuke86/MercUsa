...
function Header()
{
    ...
    //if ($_GET['affari'] == 'yes') {
    	    $this->Cell(0,0,'REGISTRO DEGLI ACQUISTI',0,1,'L');
    //}else{
...
$pdf->AddPage();
	...
	while ($results = mysqli_fetch_array($result)) {
		...
		$totAcquisti = $totAcquisti+$acquisto;
	}
	...
	$totAcquisti = money_format('%.2n',$totAcquisti);
...
$pdf->Cell(0,10,'Acquisti:                            '.EURO.' '.$totAcquisti,0,1);
